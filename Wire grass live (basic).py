...
plt.plot(T_c2[0:43],r_e2(V_e2,t2)[0:43],'s',ms=5,color = 'Blue',label='exp_20 $^\circ$C/min')
...
plt.plot(T_c2[0:43],V_e2[0:43],'s',ms=5,color = 'Blue',label='exp_20 $^\circ$C/min')
