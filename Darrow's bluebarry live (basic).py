...
plt.plot(T_c[0:43],r_m(t,AT,ET,V_inT)[0][0:43],color = 'Green',label='mod1')
plt.plot(T_c2[0:44],r_m2(t2,AT,ET,V_inT)[0],color = 'Blue',label='mod2')
plt.plot(T_c3[0:43],r_m3(t3,AT,ET,V_inT)[0],color = 'M',label='mod3')
plt.xlabel('Temperature (C)')
plt.ylabel('DIG (DV/Dt)')
plt.legend()
plt.grid()
...
plt.xlabel('Temperature (C)')
plt.ylabel('TG (V)')
plt.plot(T_c[0:45],r_m(t,AT,ET,V_inT)[1],'g-',label='mod1')
plt.plot(T_c2[0:44],r_m2(t2,AT,ET,V_inT)[1],'b-',label='mod2')
plt.plot(T_c3[0:43],r_m3(t3,AT,ET,V_inT)[1],'m-',label='mod3')
plt.xlabel('Temperature (C)')
plt.ylabel('TG (V)')
plt.legend()
plt.grid()
